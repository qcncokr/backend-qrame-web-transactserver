...
namespace Qrame.Web.TransactServer
{
	...
	{
		public static void Append(this List<CommonParameter> parameters, string parameterName, CommonDbType dbType, object value)
		{
			parameters.Add(new CommonParameter() { ParameterName = parameterName, SqlDbType = dbType.ToString(), Value = value });
		}
