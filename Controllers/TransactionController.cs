...
namespace Qrame.Web.TransactServer.Controllers
{
	...
	public class TransactionController : ControllerBase
	{
		...
		/// <example>
		/// http://localhost:7002/api/Base64/Encode?value={"ApplicationID":"QAF","ProjectID":"ZZD","TransactionID":"TST010"}
		...
		/// <example>
		/// http://localhost:7002/api/Base64/Encode?value={"ApplicationID":"QAF","ProjectID":"ZZD","TransactionID":"TST010","ServiceID":"G01","TransactionLog":true}
		...
		public ActionResult Execute(TransactionRequest request)
		{
			...
			try
			{
				...
				if (request.TH.TRN_CD == "SMP110" && request.TH.TRN_SCRN_CD != "index")
				{
